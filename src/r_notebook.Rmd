...
```{r}
apikey="<token>"
url=paste0("http://datacovid.org/api/answers/1/age;sortiesEn24h;confinementPieces;confinementNbPersonnes;diplome;confinementResidenceHabituelle;preoccupation1;penseInfecte;departement;region/?token=",apikey)
